...
st.set_page_config(page_title="MSC v43.0 Heartbeat", layout="wide", initial_sidebar_state="expanded")
inject_custom_css()
...
# --- 主界面 ---
    ...
    # --- A. AI 伴侣 ---
        ...
        chat_history = msc.get_active_chats(st.session_state.username) # 🌟 这里的报错应该消失了
